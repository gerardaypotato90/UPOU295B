				...
				<div class="col-md-12">
					<div class="table-wrap">
						<table class="table">
						  ...
						  <tbody>
						<?php $__currentLoopData = $patientapptstatus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <form method="POST" action="<?php echo e(route('patientreschedule', $pl->id)); ?>">
                        <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH /Users/gerard.alainp/Documents/GitHub/UPOUIS295B/laravel/resources/views/patientreschedule.blade.php ENDPATH**/ ?>