				...
				<div class="col-md-12">
                    ...
                    @endif
						    <tr class="alert" role="alert">
						      <th scope="row"><div class="text-sm" aria-label="{{$pl->patientname}}">{{$pl->patientname}}</div></th>
						      <td><div class="text-sm" aria-label="{{$pl->department}}">{{$pl->department}}</div></td>
						      <td> <x-input id="rescheddate" id="datepicker" class="block mt-1 w-full datepicker form-control" type="text" name="rescheddate" :value="old('rescheddate')" aria-describedby="Reschedule" autofocus /></td>
