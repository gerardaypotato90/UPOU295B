					...
					<div class="table-wrap">
                        ...
                        @foreach ($drsched as $drs)
						    <tr class="alert" role="alert">
						      ...
						      <td><div class="text-sm" aria-label="{{$drs->availabletime}}">{{$drs->availabletime}}</div></td>
							  <td>
							 	<div class="form-group">
									<x-input type="text" name="appointmentdate" id="datepicker" class="datepicker form-control" aria-describedby="appointmentdate"/>
								</div>
							  </td>
						      <td>
